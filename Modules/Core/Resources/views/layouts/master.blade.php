...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('web/public/css/app.css') }}{{stripos(asset('web/public/css/app.css'), '?') === false ? '?' : '&'}}v={{config('core.app_version')}}" rel="stylesheet">
        @yield('styles')
    </head>
    <body>
        ...
        <script src="{{ asset('web/public/js/app.js') }}{{stripos(asset('web/public/js/app.js'), '?') === false ? '?' : '&'}}v={{config('core.app_version')}}"></script>
        @yield('scripts')
    </body>
</html>